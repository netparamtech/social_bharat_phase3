...
const EnquiryList = () => {
  ...
  const fetchEnquiries = async () => {
    try {
      const response = await fetchAllEnquiry();
  ...
  return (
    <div className="container-fluid">
      <div className="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 className="h3 mb-0 text-gray-800">Enquiry List</h1>
                  ...
                  <td>
                    {item.banner_urls ? (
                      <div className="d-flex flex-wrap">
                        {item.banner_urls && Array.isArray(item.banner_urls) ? (
                  ...
                  <td key={item.id}>
                    <div className="d-flex">
                      <a
                        ...
                        onClick={() =>
                          navigate(
                            `/admin/banners/update/${item.page}/${item.section}`
                          )
                        }
                      >
