...
import { deleteEventByID, fetchAllUsers, fetchEvents, updateToggleStatus, updateToggleStatusForEvent } from '../../services/AdminService';
...
const Event = () => {
  ...
  const columns = [
    ...
    {
      title: 'Thumb Image', field: 'thumb_image',
      render: (rowData) => (
    ...
    {
      title: 'Banner Image', field: 'banner_image',
      render: (rowData) => (
