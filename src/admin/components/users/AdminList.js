...
import { fetchAdmin, fetchAllUsers, permissionById, toggelAdmin, updatePermissions, updateToggleStatus } from '../../services/AdminService';
    ...
    return (
        <div>
            <div className='d-sm-flex align-items-center justify-content-between mb-4'>
                ...
                <button className='btn btn-primary' onClick={exportToExcel}>All Users</button>
