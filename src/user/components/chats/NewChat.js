                                ...
                                <div class="py-2 px-4 border-bottom">
                                    <div class="d-flex align-items-center py-1">
                                        ...
                                        <div class="flex-grow-1 pl-3 ms-2">
                                            <strong class="fs-6 text-white"> {user && user.user && user.user.name}</strong>
                                            <div class="text-muted small "><em class="text-white">Online</em></div>
                                        </div>
                                        <div>
                                            <button
                                                        ...
                                                        item.sender_id === user.user.id ? (
                                                            <div class="chat-message-right pb-4">
                                                                ...
                                                                <div class="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
                                                                    ...
                                                                    <p class="p-0 m-0 font-messages">{item.message}</p>
                                                                </div>
                                                            </div>
                                                        ) : (
                                                            <div class="chat-message-left pb-4">
                                                                ...
                                                                <div class="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                                                                    <div class="font-weight-bold mb-1">{selectedUser && selectedUser.name}</div>
                                                                    <p class="p-0 m-0 font-messages">{item.message}</p>
                                                                </div>
                                                            </div>
                                                        )
