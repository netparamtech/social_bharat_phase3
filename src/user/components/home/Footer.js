                ...
                <div className="row pt-5 pb-5">
                    <div className="col-lg-3 col-md-6 col-sm-12 mb-3">
                        ...
                        <div className="social-links">
                            ...
                            <a href="#" className="skype"><i className="fa-brands fa-skype "></i></a>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-12 useful-links mb-md-5 ps-sm-0 ps-xs-0 ps-lg-5 ps-md-5">
                        ...
                        <ul className="list-inline">
                            <li className="green-ever-hover"> <a href="#" className="text-decoration-none gray-color"><i
                                        className="fa-solid fa-chevron-right green-ever me-2"></i>
                                    Home</a> </li>
                            <li className="green-ever-hover"><a href="#" className="text-decoration-none gray-color"><i
                                        className="fa-solid fa-chevron-right green-ever me-2"></i>
                                    Events</a></li>
                            <li className="green-ever-hover"><a href="#" className="text-decoration-none gray-color"><i
                                        className="fa-solid fa-chevron-right green-ever me-2"></i>
                                    About</a></li>
                            <li className="green-ever-hover"><a href="contact.html" className="text-decoration-none gray-color"><i
                                        className="fa-solid fa-chevron-right green-ever me-2"></i>
                                    Contact</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-12">
                        <h3>Contact Us</h3>
                        <p>747, Janpath,Rani
                            sathi nagar,<br /> Nirman nagar, jaipur-302019<br />
                            Rajasthan
                            <br />
                            <strong>phone:</strong>
                            +91-96492-72709
