                    ...
                    <div className="card mb-3">
                        ...
                        <div className="card-header">
                            ...
                            <div className="text-light bg-info">
                                You are searching for-{activeNavItem} jobs in state-{selectedState ? selectedState.label : 'All'}
                                {" "}and city-{selectedCity ? selectedCity.label : 'All'}
                            </div>
                        </div>
                                                                    ...
                                                                    errors && errors.job_id ? (
                                                                        <Offcanvas show={show} onHide={handleClose} placement={"bottom"}>
                                                                            <Offcanvas.Header closeButton>
                                                                                <Offcanvas.Title className="text-danger mx-auto"><b>{jobTitle}</b></Offcanvas.Title>
                                                                            </Offcanvas.Header>
                                                                            <Offcanvas.Body className="text-danger mx-auto">
                                                                                "Application Error: You have already submitted an application for this job. Duplicate applications are not allowed. If you have any questions or concerns, please contact our support team."
                                                                                <p className="mx-auto"><button className="btn btn-success mt-3" onClick={() => navigate('/contact')}>Contact Us</button></p>
                                                                            </Offcanvas.Body>
                                                                        </Offcanvas>
                                                                    ) : ''
                                                                }
