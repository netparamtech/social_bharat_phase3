...
const ViewProfileDrawer = ({ visible, onClose }) => {
    ...
    useEffect(() => {
        ...
        setProposalPhotos(user && user.matrimonial && user.matrimonial[0] && user.matrimonial[0].proposal_photos)
        setContactDetails(user?.contacts);
        setEducationDetails(user?.education);
        setBusinessDetails(user?.businesses);
        setBusinessPhotos(user &&
            user.businesses &&
            user.businesses.business_photos)
        ...
        <Drawer width={640} placement="right" closable={visible} onClose={onClose} open={visible}>
            ...
            <div className="drawer-header mt-5">
                <p className="d-flex flex-column flex-sm-row">
                    ...
                    <a href='#auth-wrapper' className="me-2 me-sm-3">Matrimonial</a>
                    <a href='#contact-section' className="me-2 me-sm-3">Address</a>
                    <a href='#auth-wrapper-job' className="me-2 me-sm-3">Job Info</a>
                    <a href='#education-section' className="me-2 me-sm-3">Education Info</a>
                    <a href='#contacts' className="me-2 me-sm-3">Contacts</a>
                    <a href='#businesses-section' className="me-2 me-sm-3">Business Info</a>
                </p>
            </div>

            <div id='personal' className='mt-2'>
                <p
                ...
                <DescriptionItem title="Occupation" content={user && user.occupation ? user.occupation : "NA"} />
                <Divider />
            </div>
                                                ...
                                                <div className="row">
                                                    <div className="mb-3 col-md-6  col-sm-12 col-xs-12">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-md-8">
                                                                <label className="">{user && user.matrimonial[0] && user.matrimonial[0].father_name}</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="mb-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-md-8">
                                                                <label className="">
                                                                    {user && user.matrimonial[0] && user.matrimonial[0].mother_name}
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="row">
                                                    <div className="mb-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-md-8">
                                                                <label className="">
                                                                    {user && user.matrimonial[0] && user.matrimonial[0].skin_tone}
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="mb-3 col-md-6 col-sm-12 col-xs-12">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-md-8">
                                                                <label className="">
                                                                    {user && user.matrimonial[0] && user.matrimonial[0].height_in_feet}
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="row">
                                                    <div className="mb-3 col-lg-6 col-sm-12 col-xs-12">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-md-8">
                                                                <label className="">
                                                                    {user && user.matrimonial[0] && user.matrimonial[0].weight_in_kg}
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="mb-3 col-lg-6 col-sm-12 col-xs-12">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-md-8">
                                                                <label className="">
                                                                    {user && user.matrimonial[0] && user.matrimonial[0].paternal_gotra}                          </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="row">
                                                    <div className="mb-3 col-lg-6 col-sm-12 col-xs-12">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-md-8">
                                                                <label className="">
                                                                    {user && user.matrimonial[0] && user.matrimonial[0].maternal_gotra}
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="mb-3 col-lg-6 col-sm-12 col-xs-12">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-md-8">
                                                                <label className="">
                                                                    {user && user.matrimonial[0] && user.matrimonial[0].biodata && (
                                                                        <span>
                                                                            <a href={user.matrimonial[0].biodata} download="biodata.pdf">
            ...
            <div id="contact-section" className="content-wrapper pt-4">
                <div className="container">
                    <div className="card shadow">
                        ...
                        <div className="card-body">
                            <h5 className="mb-3 fw-bold fs-5">Address Info</h5>
                            <div className="row">
            ...
            <div id="auth-wrapper-job" className="pt-5 pb-5 mt-2">
                <div id="event-info" className="container">
                    <div className="card shadow">
                        <div className="card-body">
                            <div className="row">
                                <div className="col-md-12 col-sm-12 col-xs-12 ">
                                    <div className="card-title">
                                        <h3 className="mb-3 fw-bold fs-5">Jobs Info</h3>
                                    </div>
                                    {
                                        user && user.jobs && user.jobs.length > 0 ? (
                                            user && user.jobs && user.jobs.map((item, index) => (
                                                    ...
                                                    <div className="card shadow mb-2">
                                                        <table className="table table-striped">
                                                            <tbody>
                                                                <tr>
                                                                    <td>Company Name</td>
                                                                    <td className="text-muted fw-bold">{item.company_name || 'NA'}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Designation</td>
            ...
            <div id='contacts' className="mb-3">
                ...
                <Row>
                    ...
                    <Col xs={24} sm={12} md={12} lg={12} xl={12}>
                        <DescriptionItem title="Phone Number" content={user && user.mobile} />
                    </Col>
                </Row>
                <Row>
                    <Col xs={24}>
